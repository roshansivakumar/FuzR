...
a2tpCd1 = mfAC.trapmfAreaC(dist1, [26.0, 29.5, 36.5, 40.0], [
                           36.0, 40.0, 48.0, 52.0], a1tpUd1, a2tpUd1)
a3tpCd1 = mfAC.trapmfAreaC(dist1, [36.0, 40.0, 48.0, 52.0], [
                           44.0, 50.7, 64.1, 71.0], a2tpUd1, a3tpUd1)
a4tpCd1 = mfAC.trapmfAreaC(dist1, [44.0, 50.7, 64.1, 71.0], [
                           63.0, 70.7, 83.1, 94.0], a3tpUd1, a4tpUd1)
